<?php
    ...
    if(is_user_logged_in()):
        ...
        <button data-product-id="<?= esc_attr($product->get_id()) ?>"
                ...
                class="group cursor-pointer ajax-add-to-wishlist shrink-0 w-12 h-12 flex items-center justify-center bg-white-900 border border-neutral-800">
    ...
    <?php else: ?>
        <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" class="shrink-0 w-12 h-12 flex items-center justify-center bg-white-900 border border-neutral-800">
